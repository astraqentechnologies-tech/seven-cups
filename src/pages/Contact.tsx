    ...
    <div className='min-h-screen bg-stone-50'>
      ...
      <div className='relative bg-stone-900 overflow-hidden py-20'>
        ...
        <div className='relative max-w-4xl mx-auto px-6 text-center'>
          ...
          <h1 className='text-5xl font-bold text-white font-serif mt-3 mb-4'>
            We'd Love to Hear From You
          </h1>
          <p className='text-stone-300 text-lg max-w-xl mx-auto'>
            Whether you have a question about our teas, need a recommendation,
            or simply want to chat about your next brew — we're here.
          </p>
        </div>
      </div>
          ...
          <div className='space-y-6'>
            <div>
              ...
              <p className='text-stone-500 text-sm leading-relaxed'>
                Our team of tea experts is ready to assist you.
              </p>
            </div>
            ...
            {[
              {
                icon: Mail,
                label: 'Email Us',
                value: 'sevencupsofficial@gmail.com',
              ...
              { icon: Phone, label: 'Call Us', value: '+91 7980505146' },
              {
                icon: MapPin,
                label: 'Visit Us',
                value: 'S S Enterprise, 100, Dewangazi Road,',
                sub: 'Bally – Howrah, West Bengal – 711201, India'
              }
            ].map((info, i) => (
              <div
                key={i}
                className='flex items-start gap-4 bg-white rounded-2xl p-5 border border-stone-100 shadow-sm'
              >
                ...
                <div>
                  <p className='text-stone-500 text-xs uppercase tracking-wide font-medium mb-0.5'>
                    {info.label}
                  </p>
              ...
              <div className='flex gap-3'>
                {['Instagram', 'Facebook', 'Twitter'].map(s => (
                  <a
                    key={s}
                    href='#'
                    className='px-4 py-2 bg-white border border-stone-200 rounded-full text-xs font-medium text-stone-600 hover:border-amber-400 hover:text-amber-600 transition-all'
                  >
                    {s}
                  </a>
                ))}
              ...
              {submitted ? (
                <div className='text-center py-12'>
                  ...
                  <p className='text-stone-500 leading-relaxed'>
                    Thank you for reaching out. Our tea specialists will get
        ...
        <div className='mt-16 bg-white rounded-3xl border border-stone-100 overflow-hidden shadow-sm h-72 flex items-center justify-center'>
          <div className='text-center'>
            ...
            <p className='text-stone-600 font-semibold'>
              S S Enterprise, 100, Dewangazi Road
            </p>
            <p className='text-stone-400 text-sm mt-1'>
              Bally – Howrah, West Bengal – 711201, India
            </p>
          </div>
        </div>
      </div>
